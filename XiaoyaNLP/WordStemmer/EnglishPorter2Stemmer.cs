    ...
    public class EnglishPorter2Stemmer : IPorter2Stemmer
    {
        ...
        private static readonly char[] _alphabet =
            Enumerable
                ...
                .Select(c => (char)c)
                .Concat(new[] { '\'' }).ToArray();
        public static char[] Alphabet { get { return _alphabet; } }
        ...
        private static readonly char[] _liEndings = "cdeghkmnrt".ToArray();
        ...
        private static readonly string[] _exceptionsPart2 = new[]
            {
                "inning", "outing", "canning", "herring", "earring",
                "proceed", "exceed", "succeed"
            };

        private static readonly string[] _exceptionsRegion1 = new[]
            {
                "gener", "arsen", "commun"
            };
